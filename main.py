...
#             text = font.render(f"Player {num} wins!", True, (255, 255, 255))
#             screen.blit(text, (WINDOW_SIZE[0] // 2 - 120, WINDOW_SIZE[1] // 2 - 40))
            
#             restart_button = pygame.draw.rect(screen, (0, 255, 0), (10, WINDOW_SIZE[1] - 40, 80, 30))
...
def draw_board():
    ...
    if winner:
        ...
        num = 1 if winner == PLAYER_X else 2
        font = pygame.font.Font(None, 50)
        text = font.render(f"Player {num} wins!", True, (255-PLAYER_O_COLOR[0], 255-PLAYER_O_COLOR[0], 255-PLAYER_O_COLOR[0]))
        screen.blit(text, (WINDOW_SIZE[0] // 2 - 120, WINDOW_SIZE[1] // 2 - 40))
